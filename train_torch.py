...
class CharDataset(Dataset):
    def __init__(self, chats, tok_path, vocab, max_len=36):
        self._data = chats
...
class KoGPT2Chat(LightningModule):
    ...
    def train_dataloader(self):
        data = pd.read_csv('/home/brainai/anaconda3/KoGPT2-chatbot/drama1.csv')
...
if __name__ == "__main__":
    ...
    if args.train:
        ...
        #model = KoGPT2Chat.load_from_checkpoint('model_chp/model_-epoch=01-loss=2.08.ckpt')
